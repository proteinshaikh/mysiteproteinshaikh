...
const stockTips: StockTip[] = [
    {
        title: 'Investment Lessons from Warren Buffett',
        excerpt: 'Buffett’s timeless principles on value investing and discipline.',
        link: '/stocks/buffet-lessons',
    },
];

function Stocks(): JSX.Element {
    return (
        <>
            <Helmet>
            ...
            <section
                ...
                <div className="max-w-4xl w-full text-center relative z-10">
                    ...
                    <p className="text-gray-600 mb-12 text-lg animate-fade-in-up max-w-2xl mx-auto">
                        Dive into my collection of stock market insights, inspired by timeless strategies to guide your
                        investment journey. 💡
                    </p>
