        ...
        return (
            <section className="container mx-auto px-4 py-16 max-w-3xl">
                ...
                <article className="bg-white p-6 rounded-lg shadow-lg leading-relaxed">
                    ...
                    <p className="mb-4">
                        In early 2025, I weighed 89 kg. Tired of low energy and discomfort, I committed to transforming
                        my body with
                    ...
                    <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                        <li><strong>Calorie Deficit:</strong> 1800–2000 kcal/day with <a
                            href="https://www.myfitnesspal.com" className="text-blue-500 hover:underline"
                            target="_blank" rel="noopener noreferrer">MyFitnessPal</a></li>
                        <li><strong>Steps:</strong> 8,000–10,000 daily to stay active and improve NEAT</li>
                        <li><strong>Strength Training:</strong> 3–4x/week using <a href="https://musclewiki.com/"
                                                                                   className="text-blue-500 hover:underline"
                                                                                   target="_blank"
                                                                                   rel="noopener noreferrer">MuscleWiki</a> to
                            plan exercises
                        </li>
                        <li><strong>Sunlight:</strong> 15 minutes of natural light daily for better circadian rhythm and
                            mood
                        </li>
                    ...
                    <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                        ...
                        <li><strong>Lunch:</strong> Grilled chicken breast + white rice + cucumber + steamed veggies
                        </li>
                        ...
                        <li><strong>Cheat Meals:</strong> Once a week — Indian sweets or dark chocolate, guilt-free 🍫
                        </li>
                    </ul>
                    ...
                    <p className="mb-4">
                        Tracking my meals made the biggest difference. I used <a href="https://www.myfitnesspal.com"
                                                                                 className="text-blue-500 hover:underline"
                                                                                 target="_blank"
                                                                                 rel="noopener noreferrer">MyFitnessPal</a> to
                        log every bite and
                        understand macros. For workouts, <a href="https://musclewiki.com/"
                                                            className="text-blue-500 hover:underline" target="_blank"
                                                            rel="noopener noreferrer">MuscleWiki</a> became my exercise
                        encyclopedia.
                    </p>
                    ...
                    <figure className="my-6 text-center">
                        ...
                        />
                        <figcaption className="text-sm text-gray-500 mt-2">My transformation: 89 kg → 72 kg (Jan–May
                            2025)
                        </figcaption>
                    </figure>
                    ...
                    <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                        <li><strong>Consistency beats perfection</strong> — every meal doesn’t need to be perfect, but
                            aim for balance.
                        </li>
                        <li><strong>Track your inputs</strong> — use apps and spreadsheets to stay on top of your food
                            and workouts.
                        </li>
                    ...
                    <p className="text-lg font-semibold text-accent">
                        Build a routine. Track honestly. Respect the process. You’ll transform — one smart decision at a
                        time. 💪
                    </p>
                </article>
            </section>
