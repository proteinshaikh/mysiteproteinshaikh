    ...
    return (
        <>
            ...
            <section className="max-w-4xl mx-auto px-4 py-8 space-y-6">
                ...
                {/* Report Preview */}
                <div ref={reportRef} className="bg-white p-10 text-gray-800 font-sans text-sm">
                    ...
                    <section className="mb-6">
                        ...
                        <div className="mt-2 text-sm">
                            <ul className="list-disc pl-5 space-y-1">
                                <li><strong>BMI</strong>: Body Mass Index, calculated as weight (kg) ÷ height² (m²).
                                </li>
                                <li><strong>BMR</strong>: Basal Metabolic Rate (Mifflin-St Jeor), approximate resting
                                    calories burned daily.
                                </li>
                                <li><strong>TDEE</strong>: Total Daily Energy Expenditure, calculated as BMR × activity
                                    level.
                                </li>
                                <li><strong>Body Fat %</strong>: Estimated using the US Navy tape measurement method.
                                </li>
                                <li><strong>Lean Mass</strong>: Body weight minus fat mass, calculated as weight × (1 -
                                    fat %).
                                </li>
                                <li><strong>Target Calories</strong>: TDEE minus calorie deficit, guiding daily intake
                                    for weight goals.
                                </li>
                                <li><strong>Estimated Weekly Loss</strong>: Based on 7 × deficit (kcal) ≈ 1 kg change.
                                </li>
                            </ul>
                        </div>
                    </section>
