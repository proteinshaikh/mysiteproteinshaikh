...
function Navbar(): JSX.Element {
    ...
    /* auto-close mobile drawer on scroll */
    useEffect(() => {
            ...
            <nav className="bg-white shadow-md sticky top-0 z-50">
                <div className="container mx-auto px-4 py-4 flex items-center">
                    ...
                    <Link to="/" className="flex items-center gap-2 shrink-0">
                        ...
                        <span className="text-2xl font-bold font-[Playfair_Display] text-gray-800">
              ProteinShaikh
            </span>
                    </Link>
                    ...
                    <button
                        ...
                        className="ml-auto lg:hidden text-gray-700 focus:outline-none"
                    >
                    ...
                    {/* desktop menu --------------------------------------------------- */}
                    <div className="ml-auto hidden lg:flex items-center gap-3 relative whitespace-nowrap text-sm">
                        <Link
                            to="/calculators"
                        ...
                        >
                            <CalculatorIcon className="h-4 w-4 text-blue-700"/>
                            <span>Health Calcs</span>
                        </Link>
                        ...
                        <a
                            ...
                            className="px-3 py-2 rounded-lg text-gray-700 hover:bg-gray-100 transition font-medium"
                        >
                            Contact
                        </a>
                        ...
                        {token ? (
                            <>
                                <Link
                                    to="/profile"
                                    className="px-3 py-2 rounded-lg bg-green-100 text-green-800 hover:bg-green-200 transition font-medium"
                                >
                                    Profile
                                </Link>
                                <button
                                    onClick={logout}
                                    className="px-3 py-2 rounded-lg bg-gray-100 text-gray-800 hover:bg-gray-200 transition font-medium"
                                >
                                    Logout
                                </button>
                            </>
                            ...
                            <button
                                ...
                                className="px-3 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition font-medium"
                            >
                                Login
                            </button>
                        )}
                ...
                {/* mobile drawer ---------------------------------------------------- */}
                {isOpen && (
                    <div className="lg:hidden bg-white px-4 pb-4 space-y-3 pt-2">
                        <MobileNavItem to="/calculators" onClick={() => setIsOpen(false)}>
                            Calculators
                        </MobileNavItem>
                        <MobileNavItem to="/tech" onClick={() => setIsOpen(false)}>
                            Tech
                        </MobileNavItem>
                        <MobileNavItem to="/fitness" onClick={() => setIsOpen(false)}>
                            Fitness
                        </MobileNavItem>
                        <MobileNavItem to="/stocks" onClick={() => setIsOpen(false)}>
                            Stocks
                        </MobileNavItem>
                        <MobileNavItem to="/blogs" onClick={() => setIsOpen(false)}>
                            Blogs
                        </MobileNavItem>
                        ...
                        {token ? (
                            <>
                                <Link
                                    ...
                                    className="w-full bg-green-100 border border-green-200 rounded-lg px-4 py-3 font-medium text-green-800 shadow-sm hover:bg-green-200 transition mb-2"
                                >
                                    Profile
                                </Link>
                                <button
                                    ...
                                    className="w-full bg-gray-100 border border-gray-200 rounded-lg px-4 py-3 font-medium text-gray-800 shadow-sm hover:bg-gray-200 transition"
                                >
                                    Logout
                                </button>
                            </>
                            ...
                            <button
                                ...
                                className="w-full bg-blue-600 rounded-lg px-4 py-3 font-medium text-white shadow-sm hover:bg-blue-700 transition"
                            >
                                Login
                            </button>
                        )}
...
type MobileNavItemProps = { to: string; children: ReactNode; onClick?: () => void };
...
type DropdownNavItemProps = { title: string; baseLink: string; articles: Article[] };
...
const DropdownNavItem = ({title, baseLink, articles}: DropdownNavItemProps): JSX.Element => {
    ...
    return (
        <div className="relative" onMouseEnter={onEnter} onMouseLeave={onLeave}>
            <Link
                to={baseLink}
                className="flex items-center gap-1 px-3 py-2 rounded-lg text-gray-700 hover:bg-gray-100 font-medium"
            >
                {title}
