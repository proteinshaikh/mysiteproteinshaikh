        ...
        <>
            ...
            <section className="prose prose-lg max-w-4xl mx-auto px-4 py-12">
                ...
                <ul className="list-disc list-inside space-y-2">
                    ...
                    <li>Religious identity tends to follow geography, culture, and family—rather than personal choice.
                    </li>
                ...
                <p>
                    True belief is not what you're born into—it’s what you choose after questioning, learning, and
                    understanding.
                </p>
            </section>
        </>
