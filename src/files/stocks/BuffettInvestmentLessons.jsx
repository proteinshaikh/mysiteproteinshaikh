  ...
  return (
    <>
      ...
      <section className="prose prose-lg max-w-4xl mx-auto px-4 py-12">
        ...
        <p>
          Ask yourself: <em>“Has anybody done something foolish that gives me the opportunity to buy a great business at a great price?”</em>
          That’s the Buffett mindset—buy great companies, understand them deeply, and wait patiently with discipline and courage.
        </p>
      </section>
    </>
  );
