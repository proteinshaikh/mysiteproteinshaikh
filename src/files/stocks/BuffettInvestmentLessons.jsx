...
function BuffettInvestmentLessons() {
    return (
        <>
            <Helmet>
            ...
            <section className="prose prose-lg max-w-4xl mx-auto px-4 py-12">
                ...
                <ul className="list-disc list-inside space-y-2">
                    <li>Spend more time reading <strong>annual reports</strong>, industry articles, and business news.
                    </li>
                    <li>Know the company through its <strong>customers, competitors, and former employees</strong>.</li>
                    <li>Buffett follows <strong>Ben Graham</strong> (value investing) and <strong>Phil
                        Fisher</strong> (business quality).
                    </li>
                </ul>
                ...
                <div className="md:flex md:items-start md:gap-6 mb-6">
                    ...
                    <ul className="list-disc list-inside space-y-2 mt-4 md:mt-0">
                        ...
                        <li>A <strong>dividend-paying company</strong> should ideally have <strong>zero debt</strong>.
                        </li>
                ...
                <ul className="list-disc list-inside space-y-2">
                    <li>Look through metrics like <strong>ROE</strong> (Return on Equity) and <strong>Margin of
                        Safety</strong>.
                    </li>
